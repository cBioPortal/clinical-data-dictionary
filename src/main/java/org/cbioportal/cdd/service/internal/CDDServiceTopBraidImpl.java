...
@Service
@Qualifier("topbraid")
public class CDDServiceTopBraidImpl implements ClinicalDataDictionaryService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CDDServiceTopBraidImpl.class);

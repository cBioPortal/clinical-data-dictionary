...
public class CDDServiceKnowledgeSystemsImpl implements ClinicalDataDictionaryService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CDDServiceKnowledgeSystemsImpl.class);
